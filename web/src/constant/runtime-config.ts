...
type RuntimeConfig = {
    ...
    CANVAS_PROXY_URL?: string; // Same-origin or public forwarding proxy base URL
};
...
export const CANVAS_PROXY_URL = read("CANVAS_PROXY_URL", import.meta.env.VITE_CANVAS_PROXY_URL);
